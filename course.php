        ...
        <div class="row courses">
            <div class="col-xl-4">
                <div class="course_item">
                    <div class="card">
                        <img src="./image/courseno1.png" class="card-img-top" alt="...">
                        <div class="card-body course_item_content">
                          <span>$82/Person</span>
                          <h3 class="card-title">Extended Driving
                            Course</h3>
                        ...
                        <a href="#" class="btn course_button">Start Now</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-4">
...
<section class="pricing">
    <div class="container">
        <div class="row">
            <div class="col-xl-12 pricing_plans">
                <div class="pricing_plan">
                    <div class="card" style="width: 18rem; border-radius: 0%;">
                        <div class="card-body plan1">
                          <h5 class="card-title">Basic</h5>
                          <p class="card-text">Righteous indignation & <br>
                            well dislike</p>
                            
                          <div class="price"><h4>&</h4><span>54</span><h6>/Per Person</h6></div>
                          <hr>
                          <ul class="course_plan">
                            <li><i class="fa-solid fa-circle" style="color: #f1f505;"></i><span> 60 Mins Driving Lesson</span></li> 
                            <li><i class="fa-solid fa-circle" style="color: #f1f505;"></i><span> 60 Mins Driving Lesson</span></li> 
                            <li><i class="fa-solid fa-circle" style="color: #f1f505;"></i><span> 60 Mins Driving Lesson</span></li> 
                            <li><i class="fa-solid fa-circle" style="color: #f1f505;"></i><span> 60 Mins Driving Lesson</span></li> 
                          </ul>
                          <button type="button" class="btn course_plan_button">Start Now</button>
                        </div>
                      </div>
                </div>
                <div class="pricing_plan">
        ...
        <div class="row">
            ...
            <div class="col-xl-7">
                <div class="row testimonial_content">
                        <div class="col-xl-6 testimonial_content_img">
